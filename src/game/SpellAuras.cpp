...
pAuraHandler AuraHandler[TOTAL_AURAS]=
{
    ...
    &Aura::HandleNULL,                                      //307 3 spells
    &Aura::HandleNULL,                                      //308 5 spells
    &Aura::HandleNULL,                                      //309 3 spells
    &Aura::HandleNoImmediateEffect,                         //310 5 spells SPELL_AURA_RANGED_AP_ATTACKER_CREATURES_BONUS implemented in Unit::MeleeDamageBonus
    &Aura::HandleNULL,                                      //311 unused
    &Aura::HandleNULL,                                      //312 unused
    &Aura::HandleNULL,                                      //313 unused
    &Aura::HandleNULL,                                      //314 1 spell
    &Aura::HandleNULL,                                      //315 2 spells
    &Aura::HandleNULL                                       //316 4 spells
};
#undef Aura
        ...
        switch(auraSpellInfo->SpellFamilyName)
        {
            case SPELLFAMILY_GENERIC:
            {
                switch(auraId)
                {
                    ...
                    case 46736: trigger_spell_id = 46737; 
                        break;
                    // Prey on the Weak
                    case 51685:
                    case 51686:
...
void AuraEffect::HandleAuraModWeaponCritPercent(bool apply, bool Real, bool changeAmount)
{
    ...
    if(Real || changeAmount)
    {
        for (int i = 0; i < MAX_ATTACK; ++i)
            if(Item* pItem = ((Player*)m_target)->GetWeaponForAttack(WeaponAttackType(i), true))
