/*
* Copyright (C) 2005,2006,2007 Trinity <http://www.trinitycore.org/>
*
...
class ChatLog : public Trinity::Singleton<ChatLog, Trinity::ClassLevelLockable<ChatLog, /*ZThread::Mutex*/ACE_Thread_Mutex> >
{
    public:
        ChatLog();
        ~ChatLog();
...
#define sChatLog Trinity::Singleton<ChatLog>::Instance()
#endif