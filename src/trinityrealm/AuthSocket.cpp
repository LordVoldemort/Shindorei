...
bool AuthSocket::_HandleLogonProof()
{
    ...
    if (!memcmp(M.AsByteArray(), lp.M1, 20))
    {
        ...
        if (_build == 8606 || _build == 9947 || _build == 10146 || _build == 10505 || _build == 11159 || _build == 11403)//2.4.3, 3.1.3 and 3.2.2a clients (10146 is Chinese build for 3.1.3)
        {
...
bool AuthSocket::_HandleRealmList()
{
    ...
    {
        if (_build == 8606 || _build == 9947 || _build == 10146 || _build == 10505 || _build == 11159 || _build == 11403)//2.4.3, 3.1.3 and 3.2.2a clients
        {
    ...
    ByteBuffer pkt;
    pkt << (uint32) 0;
    if (_build == 8606 || _build == 9947 || _build == 10146 || _build == 10505 || _build == 11159 || _build == 11403)//only 2.4.3, 3.1.3 and 3.2.2a clients
    ...
    for (i = built_realmList.begin(); i != built_realmList.end(); ++i)
    {
        ...
        if (i->second.gamebuild == 11403 || i->second.gamebuild == 11159 || i->second.gamebuild == 10505 || i->second.gamebuild == 9947 || i->second.gamebuild == 10146 || i->second.gamebuild == 8606)//only 2.4.3, 3.1.3 and 3.2.2a clients
        ...
        if (i->second.gamebuild == 11403 || i->second.gamebuild == 11159 || i->second.gamebuild == 10505 || i->second.gamebuild == 9947 || i->second.gamebuild == 10146 || i->second.gamebuild == 8606)//2.4.3, 3.1.3 and 3.2.2a clients
            pkt << (uint8) 0x2C;                                // unk, may be realm number/id?
        else
            pkt << (uint8) 0x0; //1.12.1 and 1.12.2 clients
    }

    if (_build == 11403 || _build == 11159 || _build == 10505 || _build == 9947 || _build == 10146 || _build == 8606)//2.4.3, 3.1.3 and 3.2.2a clients
    {
        pkt << (uint8) 0x10;
        pkt << (uint8) 0x00;
