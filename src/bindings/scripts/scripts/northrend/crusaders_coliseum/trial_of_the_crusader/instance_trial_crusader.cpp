...
struct TRINITY_DLL_DECL instance_trial_crusader : public ScriptedInstance
{
    instance_trial_crusader(Map* pMap) : ScriptedInstance(pMap), m_uiChampionsLootGUID(NULL), m_uiPaletressLootGUID(NULL), m_uiEadricLootGUID(NULL) { Initialize(); }
